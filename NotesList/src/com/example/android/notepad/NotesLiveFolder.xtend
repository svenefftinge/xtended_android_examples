...
public class NotesLiveFolder extends Activity {
    ...
    override void onCreate(Bundle savedInstanceState) {
        ...
        if (LiveFolders.ACTION_CREATE_LIVE_FOLDER.equals(action)) {
            ...
            liveFolderIntent.setData(NotePad.LIVE_FOLDER_URI);

            // Adds the display name of the live folder as an Extra string.
            val foldername = getString(R.string.live_folder_name);
             ...
             */
            val returnIntent
                    = new Intent(Intent.ACTION_EDIT, NotePad.CONTENT_ID_URI_PATTERN);
